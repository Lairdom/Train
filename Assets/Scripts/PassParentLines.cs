...
{   
    ...
    {
        advance = false;
        lines[0] = "The woman is sitting, seemingly calm.";                 // Narrative description
        ...
        lines2[0] = "She is still trying her best to stay calm.";           // Narrative description
        ...
        yourLines2[2] = "";
        lines2[3] = "You spend a while looking through her phone.";         // Narrative description
        yourLines2[3] = "";
        lines2[4] = "My kids... Have you seen any children?";
        yourLines2[4] = "Sorry, I haven't.";
        lines2[5] = "How about this guy?";
        yourLines2[5] = "";
        lines2[6] = "She shows you a picture of a rough looking guy.";      // Narrative description 
